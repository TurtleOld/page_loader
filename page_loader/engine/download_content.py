...
def download_content(url, path):
    ...
    for tag in tags_src:
        ...
        elif tag['src'].startswith('http') and urlparse(url).netloc == urlparse(tag['src']).netloc:
            if result:
    ...
    for tag_ in tags_href:
        ...
        elif tag['href'].startswith('http') and urlparse(url).netloc == urlparse(tag['href']).netloc:
            if result:
